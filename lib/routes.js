...
Router.route('/conference/:_bridgeuniqueid', {
    ...
    waitOn: function () {
        return [Meteor.subscribe('ConferenceEvents', this.params._bridgeuniqueid), Meteor.subscribe('ConferenceSingle', this.params._bridgeuniqueid), Meteor.subscribe('ConferenceMembers', this.params._bridgeuniqueid), Meteor.subscribe('userInfo')];
    },
    fastRender: true
});
